...
![portada](https://raw.githubusercontent.com/aprendiendo-cosas/P_creacion_equipos_ecologia_CCAA/master/imagenes/portada.png)
...
+ Trabajar en equipo promueve el aprendizaje profundo: los humanos somos seres profundamente sociales y empáticos. El lenguaje nos permite compartir ideas, reflexiones y propuestas con nuestros congéneres. Se ha comprobado que este ejercicio de compartir, debatir, convencer, ser convencido, etc., facilita la fijación de conocimientos en nuestra memoria a largo plazo. Es decir, trabajar en equipo fomenta el aprendizaje profundo ([Azizan et al., 2018](https://www.sciencedirect.com/science/article/abs/pii/S1749772816300720?via%3Dihub); [Harker et al. 2007](https://research.usc.edu.au/esploro/outputs/journalArticle/Achieving-Deep-Learning-with-Student-Teamwork/99448980102621#file-0); [Oakley et al. 2004](https://www.google.com/url?sa=t&source=web&rct=j&opi=89978449&url=https://engr.ncsu.edu/wp-content/uploads/drive/1ofGhdOciEwloA2zofffqkr7jG3SeKRq3/2004-Oakley-paper(JSCL).pdf&ved=2ahUKEwippt3fyquIAxUiU6QEHRBPDEAQFnoECBkQAQ&usg=AOvVaw147RN9V490wUaNbJd0vhDk)) de diversas maneras:
  ...
  + Los estudiantes retienen información durante más tiempo.
  + Se mejoran notablemente las habilidades de comunicación.
  + Hay una mejora sustancial en la comprensión de la realidad en la que los estudiantes desarrollarán su actividad profesional en el futuro.

  Hay un viejo proverbio africano que recoge bien esta idea: 

  > *Si quieres llegar rápido, ve solo. Si quieres ir lejos, ve acompañado*
+ Trabajar en equipo es más divertido que hacerlo solo. El desarrollo de competencias de trabajo en equipo está relacionado con una mayor satisfacción académica y bienestar. Los estudiantes tienen un mayor sentido de pertenencia y compromiso con sus tareas [(Bhargava & Sharma, 2023)](https://doi.org/10.1108/heswbl-06-2022-0126). Además, el trabajo en equipo puede reducir los niveles de estrés y aumentar la motivación de los estudiantes ([Chaudhry et al., 2024](https://doi.org/10.1371/journal.pone.0297508)).
+ Necesitamos equipos que funcionen bien para cambiar el mundo. A estas alturas de la vida adulta ya habréis notado que tenemos una serie de retos socioecológicos muy relevantes (ej. cambio climático, crisis de biodiversidad, contaminación, crisis energéticas, etc.). Buena parte de estas crisis se han ocasionado porque la Humanidad aún no ha alcanzado una buena capacidad de entender que el mundo es un sistema complejo. Esto implica conocer las múltiples relaciones de interdependencia que se dan entre los elementos de dicho sistema. Hasta ahora hemos intentado gestionar los elementos de manera independiente (ej. la economía separada de la ecología). Esta mirada miope ha generado los problemas comentados anteriormente. En este contexto, necesitamos nuevos abordajes más integradores y holísticos. Para diseñar e implementar estas aproximaciones necesitamos equipos dinámicos, heterogéneos y completamente funcionales. 

Según lo anteriormente expuesto,  trabajar en equipo es positivo desde varios puntos de vista. Pero para que todas esas ventajas se pongan de manifiesto realmente, es necesario que el equipo esté bien formado y que haya normas de funcionamiento que lo hagan eficaz. Así que, como casi siempre, las técnicas docentes son buenas o malas no solo por su fundamento teórico, sino por la forma en la que se llevan a la práctica. Para tratar de formar equipos útiles y funcionales, seguiremos a continuación una serie de pasos que se describirán con detalle en las siguientes secciones:

1. Creación de los equipos de trabajo. 
2. Primeros pasos: construyendo equipo a partir de individualidades.
3. Descripción de las herramientas de comunicación que usaremos
...
+ Heterogeneidad interna. Esto quiere decir que el equipo está formado por individuos que tienen aptitudes diferentes. Es decir, no está formado por personas muy parecidas entre sí. Se ha comprobado que la heterogeneidad (diversidad) de aptitudes aumenta la disponibilidad de soluciones potenciales ante los retos de un problema concreto. En los siguientes párrafos describimos un método que pretende ayudar a crear equipos heterogéneos internamente y homogéneos entre sí (los equipos deben de ser lo más parecidos posible entre sí).
+ Definición de roles internos. Se ha comprobado que es útil asignar roles específicos dentro del equipo a diferentes personas. Esto refuerza la responsabilidad individual y promueve la motivación. Cada uno de los equipos que creemos tendrá una persona encargada de anotar los consensos y los conflictos, otra que relatará los avances del grupo, etc.
+ Normas claras para la resolución de conflictos. El conflicto es parte inherente del trabajo en equipo. Es más, si se gestiona adecuadamente, el conflicto puede ser una forma muy buena de potencial el aprendizaje. Nos dotaremos de recursos para abordar los posibles conflictos que surjan en los grupos. El profesor hará las veces de facilitador en estos casos.
...
+ Búsqueda de información en internet y en otras fuentes. Buena parte de la información que usaremos para el trabajo de la asignatura procederá de artículos científicos, fuentes de datos ambientales, informes, etc. La capacidad de encontrar información en estas fuentes y de extraer datos relevantes es muy importante.
+ Capacidad de analizar datos ambientales. La información disponible en internet no suele estar agregada de manera adecuada para satisfacer las necesidades específicas de cada caso. Por ello, es necesario procesar información (geográfica, alfanumérica, etc.) para generar conocimiento relevante. Por ejemplo, necesitaremos saber la densidad de los bosques de Sierra Nevada. Para ello usaremos datos procedentes de un inventario forestal. En los equipos de trabajo será necesario que haya estudiantes con gran capacidad para analizar estos datos.
...
<img src="https://raw.githubusercontent.com/aprendiendo-cosas/P_creacion_equipos_ecologia_CCAA/master/imagenes/survey.png" alt="encuesta" style="zoom:50%;" />
...
<img src="https://raw.githubusercontent.com/aprendiendo-cosas/P_creacion_equipos_ecologia_CCAA/master/imagenes/busqueda.png" alt="encuesta" style="zoom:100%;" />

<img src="https://raw.githubusercontent.com/aprendiendo-cosas/P_creacion_equipos_ecologia_CCAA/master/imagenes/analisis.png" alt="analisis" style="zoom:100%;" />

<img src="https://raw.githubusercontent.com/aprendiendo-cosas/P_creacion_equipos_ecologia_CCAA/master/imagenes/escritura.png" alt="escritura" style="zoom:100%;" />



<img src="https://raw.githubusercontent.com/aprendiendo-cosas/P_creacion_equipos_ecologia_CCAA/master/imagenes/sintesis.png" alt="sintesis" style="zoom:100%;" />
...
<img src="https://raw.githubusercontent.com/aprendiendo-cosas/P_creacion_equipos_ecologia_CCAA/master/imagenes/grupos.png" alt="sintesis" style="zoom:70%;" />
...
<img src="https://raw.githubusercontent.com/aprendiendo-cosas/P_creacion_equipos_ecologia_CCAA/master/imagenes/radial.png" alt="radial" style="zoom:100%;" />
...
![portada](https://raw.githubusercontent.com/aprendiendo-cosas/P_creacion_equipos_ecologia_CCAA/master/imagenes/patos_grupales.png)
...
[Aquí](https://github.com/aprendiendo-cosas/P_creacion_equipos_ecologia_CCAA/archive/refs/tags/master.zip) puedes un archivo .zip que contiene este guión en formato html y todo el material que incluye.
